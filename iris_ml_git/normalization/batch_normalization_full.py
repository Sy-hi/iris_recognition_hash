# Normalize iris images using rubber sheet model with segmentation mask
# Save full iris image
...
def batch_normalize_images(image_root, mask_root, output_root, radial_res=64, angular_res=512):
    ...
    for dirpath, _, filenames in os.walk(image_root):
        ...
        for filename in filenames:
            ...
            mask_path = os.path.join(mask_root, filename)  # Mask has same filename in different folder
...
if __name__ == "__main__":
    ...
    output_root = r"C:\Users\User\Desktop\unsw\y2\9773\ELEC9773 Databases\Database 1 - CASIA v3.0-Iris-Interval\after_process\Normalized"
